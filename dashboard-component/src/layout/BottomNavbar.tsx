...
export default function BottomNavbar() {
  ...
  return (
    <div 
      className={`fixed bottom-0 left-0 right-0 w-full border-t-2 border-gray-100 bg-white/95 backdrop-blur-md shadow-[0_-4px_20px_rgba(0,0,0,0.1)] dark:border-gray-700 dark:bg-gray-900/95 dark:shadow-[0_-4px_20px_rgba(0,0,0,0.3)] z-50 transition-transform duration-300 ease-in-out ${
        isVisible ? 'translate-y-0' : 'translate-y-full'
      }`}
    >
      <div className="flex items-center justify-between w-full lg:justify-center px-4 py-3 lg:py-4">
          {/* Desktop Navigation */}
                  ...
                  {item.subItems ? (
                    <>
                      ...
                      {openDropdown === item.name && (
                        <div className="absolute left-0 bottom-full mb-2 w-56 bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-700 rounded-xl shadow-2xl py-2 z-[101] animate-in">
          ...
          {mobileMenuOpen && (
            <>
              <div
                className="lg:hidden fixed inset-0 z-[101] bg-black/20 backdrop-blur-sm"
                onClick={() => setMobileMenuOpen(false)}
              />
              <div className="lg:hidden fixed bottom-16 left-0 right-0 z-[102] mx-4 mb-2 rounded-2xl border-2 border-gray-100 bg-white p-4 shadow-2xl dark:border-gray-700 dark:bg-gray-900 max-h-[calc(100vh-6rem)] overflow-y-auto">
