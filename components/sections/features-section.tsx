...
export function FeaturesSection() {
  return (
    <section id="features" className="py-32 px-6 relative max-w-full">
      <div className="absolute top-[50%] md:top-[40%] lg:top-[85%] xl:top-[80%] -translate-y-1/2 left-0 right-0 lg:left-[46%] flex justify-center pointer-events-none z-20 max-w-full overflow-hidden">
