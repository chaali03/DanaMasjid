...
const steps = [
  {
    ...
    title: "Donasi",
    subtitle: "dari umat",
    description: "Umat memberikan donasi melalui platform PARANTARA yang aman dan mudah digunakan.",
  },
  {
    number: "02",
    title: "Catat",
    subtitle: "di blockchain",
    description: "Setiap transaksi otomatis tercatat di blockchain, memastikan dana tidak dapat diubah atau disalahgunakan.",
  },
  {
    number: "03",
    title: "Kelola",
    subtitle: "untuk umat",
    description: "Dana digunakan untuk operasional masjid dan program pemberdayaan ekonomi masyarakat sekitar.",
  },
];
...
export function HowItWorksSection() {
  ...
  return (
    ...
    >
      <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-white/[0.01] blur-[100px] pointer-events-none" />
        ...
        <div className="relative mb-0 lg:mb-0 grid lg:grid-cols-2 gap-4 lg:gap-12 items-end">
          ...
          <div className="overflow-hidden pb-0 lg:pb-32">
            ...
            <h2 className={`text-6xl md:text-7xl lg:text-[128px] font-display tracking-tight leading-[0.85] transition-all duration-1000 delay-100 ${
              ...
              <span className="block">Donasi.</span>
              <span className="block text-white/30">Transparan.</span>
              <span className="block text-white/10">Berkah.</span>
            </h2>
          </div>
            ...
            >
              ...
              <div className="flex items-center gap-4 mb-8">
                <span className={`text-4xl font-display transition-colors duration-300 ${
                  activeStep === index ? "text-[#3b82f6]" : "text-white/20"
                }`}>
                  {step.number}
                </span>
              ...
              {/* Active indicator */}
              <div className={`absolute bottom-0 left-0 right-0 h-1 bg-[#3b82f6] transition-transform duration-500 origin-left ${
